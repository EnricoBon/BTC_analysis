function [Working_matrix,Order_Working_matrix,Order_Working_matrix_20,...
    Order_Working_matrix_10, TEMP_BTC,Interp_curve] = figures_OTISnth(OTIS_hypercube_input,...
...
saveas(f,[pwd '/Output_files_OTIS_nth/OTIS_perf_all.fig']);
saveas(f,[pwd '/Output_files_OTIS_nth/OTIS_perf_all.tif']);
close(f)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% %          ______         ___                      _ _ ___  
% %         |  ____(_)     |__ \               /\   | | |__ \ 
...
saveas(f,[pwd '/Output_files_OTIS_nth/OTIS_perf_20.fig']);
saveas(f,[pwd '/Output_files_OTIS_nth/OTIS_perf_20.tif']);
...
sgtitle({'OTIS latin hypercube';Description1;Description2},'FontSize',14);
% 
saveas(f,[pwd '/Output_files_OTIS_nth/OTIS_top100.fig']);
saveas(f,[pwd '/Output_files_OTIS_nth/OTIS_top100.tif']);
% 
close (f)
...
saveas(stat1,[pwd '/Output_files_OTIS_nth/OTIS_stat1.fig']);
saveas(stat1,[pwd '/Output_files_OTIS_nth/OTIS_stat1.tif']);
close (stat1);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% %                    _____ _        _     ___  
...
set(gcf, 'WindowState', 'maximized');
saveas(stat2,[pwd '/Output_files_OTIS_nth/OTIS_stat2.fig']);
saveas(stat2,[pwd '/Output_files_OTIS_nth/OTIS_stat2.tif']);
close (stat2)
...
saveas(stat3,[pwd '/Output_files_OTIS_nth/OTIS_stat3.fig']);
saveas(stat3,[pwd '/Output_files_OTIS_nth/OTIS_stat3.tif']);
close (stat3);
...
set(gcf, 'WindowState', 'maximized');
saveas(stat4,[pwd '/Output_files_OTIS_nth/OTIS_stat4.fig']);
saveas(stat4,[pwd '/Output_files_OTIS_nth/OTIS_stat4.tif']);
close (stat4)
